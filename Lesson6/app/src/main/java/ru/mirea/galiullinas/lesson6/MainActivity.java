package ru.mirea.galiullinas.lesson6;
...
import ru.mirea.galiullinas.lesson6.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.editTextGroup.setText(sharedPref.getString(GROUP_KEY, "unknown"));
        binding.editTextNumInGroup.setText(sharedPref.getString(NUM_IN_GROUP_KEY, "unknown"));
        binding.editTextFavFilm.setText(sharedPref.getString(FAVOURITE_FILM_KEY, "unknown"));
