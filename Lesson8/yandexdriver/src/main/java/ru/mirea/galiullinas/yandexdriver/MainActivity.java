package ru.mirea.galiullinas.yandexdriver;
...
import ru.mirea.galiullinas.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener,
        UserLocationObjectListener {
    private static final int REQUEST_CODE_PERMISSION = 100;
    private ActivityMainBinding binding;
    private final Point ROUTE_START_LOCATION = new Point(55.806666, 37.714806);
    private final Point ROUTE_END_LOCATION = new Point(55.794335, 37.701631);
